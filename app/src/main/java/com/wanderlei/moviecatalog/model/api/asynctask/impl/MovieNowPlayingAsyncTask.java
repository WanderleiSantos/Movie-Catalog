 ...
 */
public class MovieNowPlayingAsyncTask extends BaseAsyncTask<String , Void, List<Movie>> {

    private MovieResource movieResource;

    public MovieNowPlayingAsyncTask(Context context, MovieResource movieResource) {
        super(context);
    ...
    protected AsyncTaskResult<List<Movie>> doInBackground(String... params){
        try{
            ...
            Response<List<Movie>> listResponse = movieResource.getNowPlaying(getAPiKey(), 1).execute();
