...
public class MovieListAdapter extends RecyclerView.Adapter<MovieListAdapter.ViewHolder> implements View.OnClickListener {
    ...
    private OnItemClickListener<Movie> mMovieOnItemClickListener;

    public MovieListAdapter(List<Movie> mMovieList, OnItemClickListener<Movie> mMovieOnItemClickListener) {
        this.mMovieList = mMovieList;
        this.mMovieOnItemClickListener = mMovieOnItemClickListener;
    }
    ...
    public void onClick(View view) {
        ...
        mMovieOnItemClickListener.onClick(movie);
    }
