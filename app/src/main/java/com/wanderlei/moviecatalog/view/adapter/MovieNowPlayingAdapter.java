 ...
 */
public class MovieNowPlayingAdapter extends RecyclerView.Adapter<MovieNowPlayingAdapter.ViewHolder> implements View.OnClickListener {

    private List<Movie> movieList;
    private OnItemClickListener<Movie> movieOnItemClickListener;

    public MovieNowPlayingAdapter(List<Movie> movieList, OnItemClickListener<Movie> movieOnItemClickListener) {
